...
namespace Calcoo.Test
{
    ...
    internal class CpuTest
    {
        ...
        public void GetAngleUnitsTest()
        {
            ...
            Assert.That(cpu.CurrentAngleUnits, Is.EqualTo(Settings.AngleUnits.Rad), "switched once");
        }
        ...
        public void SetEnterModeTest()
        {
            ...
            Assert.That(cpu.CurrentEnterMode, Is.EqualTo(Settings.EnterMode.Hp28), "set to HP28");
            cpu.CurrentEnterMode = Settings.EnterMode.Traditional;
            Assert.That(cpu.CurrentEnterMode, Is.EqualTo(Settings.EnterMode.Traditional), "set to TRADITIONAL");
            cpu.CurrentEnterMode = Settings.EnterMode.Hp28;
            Assert.That(cpu.CurrentEnterMode, Is.EqualTo(Settings.EnterMode.Hp28), "set to HP28 again");
        ...
        public void SetStackModeTest()
        {
            ...
            Assert.That(cpu.CurrentStackMode, Is.EqualTo(Settings.StackMode.Xyzt), "set to XYZT");
            cpu.CurrentStackMode = Settings.StackMode.Infinite;
            Assert.That(cpu.CurrentStackMode, Is.EqualTo(Settings.StackMode.Infinite), "set to INFINITE");
            cpu.CurrentStackMode = Settings.StackMode.Xyzt;
            Assert.That(cpu.CurrentStackMode, Is.EqualTo(Settings.StackMode.Xyzt), "set to XYZT again");
        ...
        public void SetModeTest()
        {
            ...
            Assert.That(cpu.CurrentMode, Is.EqualTo(Settings.Mode.Alg), "RPN - set to ALG");
            ...
            cpu.CurrentMode = Settings.Mode.Rpn;
            Assert.That(cpu.CurrentMode, Is.EqualTo(Settings.Mode.Rpn), "ALG - set to RPN");
            cpu.CurrentMode = Settings.Mode.Alg;
            Assert.That(cpu.CurrentMode, Is.EqualTo(Settings.Mode.Alg), "ALG - set to ALG again");
        }
